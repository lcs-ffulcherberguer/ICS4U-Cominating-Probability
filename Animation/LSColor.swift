...
class LSColor: Codable {
    ...
    public static let darkgreen: LSColor = LSColor(hue: 90, saturation: 40, brightness: 15, alpha: 100)
    public static let green2: LSColor = LSColor(hue: 90, saturation: 42, brightness: 47, alpha: 100)
